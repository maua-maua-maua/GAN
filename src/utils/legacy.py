...
from . import style_ops
from .style_ops import dnnlib
...
def load_network_pkl(f, force_fp16=False):
    ...
    # need to do some monkey patching to make sure checkpoints trained with NVIDIA's code can find everything they need
    utils.misc = misc
    sys.modules["dnnlib"] = dnnlib
    sys.modules["torch_utils"] = utils
    sys.modules["torch_utils.ops"] = style_ops
